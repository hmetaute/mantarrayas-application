(ns mantarrayas-backend.test.handler
  (:require
    [clojure.test :refer :all]
    [ring.mock.request :refer :all]
    [mantarrayas-backend.handler :refer :all]
...
(use-fixtures
  :once
  (fn [f]
    (mount/start #'mantarrayas-backend.config/env
                 #'mantarrayas-backend.handler/app-routes)
    (f)))
